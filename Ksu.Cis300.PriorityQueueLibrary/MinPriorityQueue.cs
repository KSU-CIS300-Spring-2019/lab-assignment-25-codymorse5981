    ...
    public class MinPriorityQueue<TPriority,TValue> where TPriority: IComparable<TPriority>
    {
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            else
            {
                ...
                if (big.Data.Key.CompareTo(small.Data.Key) < 0)
                {
                    big = h1;
                    small = h2;
                }
                return new LeftistTree<KeyValuePair<TPriority, TValue>>(small.Data, small.LeftChild, (Merge(small.RightChild, big)));
            }
        }
